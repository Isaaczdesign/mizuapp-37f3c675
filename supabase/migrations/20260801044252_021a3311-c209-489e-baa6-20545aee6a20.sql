ALTER TABLE public.restaurants
  ADD COLUMN IF NOT EXISTS mp_pix_enabled boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS mp_card_enabled boolean NOT NULL DEFAULT true;
...
AS $function$
  SELECT r.id, r.name, r.slug, r.logo_url, r.banner_url, r.description, r.primary_color,
         ...
         COALESCE(r.mp_pix_enabled, true) AS mp_pix_enabled,
         COALESCE(r.mp_card_enabled, true) AS mp_card_enabled,
