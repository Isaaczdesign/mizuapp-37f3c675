...
export function FloatingCartBar({
  ...
  return (
    <motion.div
      ...
      className="fixed inset-x-0 z-50 px-4 sm:px-6 pointer-events-none lg:hidden transition-[bottom] duration-[260ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] [--fcb-offset:96px] md:[--fcb-offset:16px]"
      style={{ bottom: `calc(env(safe-area-inset-bottom, 0px) + var(--fcb-offset) + ${keyboardInset}px)` }}
