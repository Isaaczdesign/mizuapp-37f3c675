        ...
        >
          ...
          <form onSubmit={handleSubmit} className="mt-6 lg:mt-8 space-y-4 lg:space-y-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: loading ? 1 : 0.985 }}
              transition={{ type: "spring", stiffness: 400, damping: 25 }}
              className="flex h-11 lg:h-12 w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-[#151515] text-sm font-semibold tracking-wide text-[#efeae1] transition-all duration-300 hover:bg-white/5 hover:border-white/20 disabled:opacity-60"
            >
